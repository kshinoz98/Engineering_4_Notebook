...
def calcTri(x1,y1,x2,y2,x3,y3):                                     #[3-8] Define a function which calulates the area of a triangle from 3 sets of coords
    try: 
...
while True:
    ...
    try:
        ...
        print(f"The area of the triangle with vertices ({x1},{y1}), ({x2},{y2}), ({x3},{y3}) is {Area} square km.")
    except:
